-- ============================================================
-- 🚀 ULTRA SCRIPT PROFISSIONAL V6.0 - MINIMIZAR NO X 🚀
...
-- ============================================
-- FUNÇÃO TOGGLE (Minimizar no X)
-- ============================================
local function updateMinimizeState()
    if minimized then
        -- Minimiza (esconde o conteúdo)
        TweenService:Create(mainFrame, TweenInfo.new(0.2), { Size = UDim2.new(0, 380, 0, 60) }):Play()
        scrollFrame.Visible = false
        closeBtn.Text = "▣" -- Símbolo de expandir
    else
        -- Expande (mostra o conteúdo)
        TweenService:Create(mainFrame, TweenInfo.new(0.2), { Size = UDim2.new(0, 380, 0, 550) }):Play()
        scrollFrame.Visible = true
        closeBtn.Text = "✕" -- Símbolo de fechar
    end
end
...
-- O botão flutuante abre o menu pela primeira vez
...
-- Função criada apenas para o código não quebrar
local function createCategory(parent, text, yPos, icon)
    ...
    frame.BorderColor3 = COLORS.TextWhite
    frame.Parent = parent
