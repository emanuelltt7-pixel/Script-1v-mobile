-- ============================================
-- 🔥 SCRIPT ULTRA APELÃO v7.0 🔥
-- 100% FUNCIONAL | TODOS OS MAPAS
-- AIMBOT | ESP | FLY | GOD MODE | E MAIS
-- ============================================
...
floatBtn.BackgroundColor3 = Color3.fromRGB(255, 200, 50)
...
titleFrame.BackgroundColor3 = Color3.fromRGB(35, 40, 70)
...
subTitle.Text = "Toque para ativar"
...
cat1.Size = UDim2.new(0.92, 0, 0, 25)
cat1.Position = UDim2.new(0.04, 0, 0.01, 0)
cat1.BackgroundTransparency = 1
cat1.Text = "⚔️ COMBATE"
cat1.TextColor3 = Color3.fromRGB(255, 100, 100)
...
-- 1. AIMBOT
local aimbotBtn, aimbotStroke = createButton(scrollFrame, "AIMBOT 100%", 0.07, Color3.fromRGB(255, 80, 80), "🎯")

aimbotBtn.MouseButton1Click:Connect(function()
    aimbotActive = not aimbotActive
    aimbotBtn.Text = aimbotActive and "🎯 AIMBOT 100% [ON]" or "🎯 AIMBOT 100% [OFF]"
    aimbotBtn.BackgroundColor3 = aimbotActive and Color3.fromRGB(20, 60, 40) or Color3.fromRGB(30, 35, 60)
...
-- 2. SUPER FAR
local farBtn, farStroke = createButton(scrollFrame, "SUPER FAR", 0.15, Color3.fromRGB(100, 200, 255), "🔭")
...
farBtn.MouseButton1Click:Connect(function()
    ...
    farBtn.BackgroundColor3 = superFarActive and Color3.fromRGB(20, 60, 40) or Color3.fromRGB(30, 35, 60)
    farStroke.Color = superFarActive and Color3.fromRGB(0, 255, 100) or Color3.fromRGB(100, 200, 255)
end)

-- 3. INSTANT KILL
local killBtn, killStroke = createButton(scrollFrame, "INSTANT KILL", 0.23, Color3.fromRGB(255, 50, 50), "💀")

killBtn.MouseButton1Click:Connect(function()
    instantKillActive = not instantKillActive
    killBtn.Text = instantKillActive and "💀 INSTANT KILL [ON]" or "💀 INSTANT KILL [OFF]"
    killBtn.BackgroundColor3 = instantKillActive and Color3.fromRGB(20, 60, 40) or Color3.fromRGB(30, 35, 60)
...
cat2.Size = UDim2.new(0.92, 0, 0, 25)
cat2.Position = UDim2.new(0.04, 0, 0.31, 0)
...
-- 4. ESP BOX
local espBtn, espStroke = createButton(scrollFrame, "ESP BOX", 0.37, Color3.fromRGB(100, 200, 255), "📦")

espBtn.MouseButton1Click:Connect(function()
    espActive = not espActive
    espBtn.Text = espActive and "📦 ESP BOX [ON]" or "📦 ESP BOX [OFF]"
    espBtn.BackgroundColor3 = espActive and Color3.fromRGB(20, 60, 40) or Color3.fromRGB(30, 35, 60)
...
-- 5. INVISIBILIDADE
local invisBtn, invisStroke = createButton(scrollFrame, "INVISIBILIDADE", 0.45, Color3.fromRGB(200, 150, 255), "👻")

invisBtn.MouseButton1Click:Connect(function()
    invisibleActive = not invisibleActive
    invisBtn.Text = invisibleActive and "👻 INVISIBILIDADE [ON]" or "👻 INVISIBILIDADE [OFF]"
    invisBtn.BackgroundColor3 = invisibleActive and Color3.fromRGB(20, 60, 40) or Color3.fromRGB(30, 35, 60)
...
-- 6. VISÃO NOTURNA
local nvBtn, nvStroke = createButton(scrollFrame, "VISÃO NOTURNA", 0.53, Color3.fromRGB(100, 150, 255), "🌙")
...
nvBtn.MouseButton1Click:Connect(function()
    ...
    nvBtn.BackgroundColor3 = nvActive and Color3.fromRGB(20, 60, 40) or Color3.fromRGB(30, 35, 60)
...
cat3.Size = UDim2.new(0.92, 0, 0, 25)
cat3.Position = UDim2.new(0.04, 0, 0.61, 0)
...
-- 7. VELOCIDADE
local speedBtn, speedStroke = createButton(scrollFrame, "VELOCIDADE", 0.67, Color3.fromRGB(100, 255, 100), "💨")

speedBtn.MouseButton1Click:Connect(function()
    speedActive = not speedActive
    speedBtn.Text = speedActive and "💨 VELOCIDADE [ON]" or "💨 VELOCIDADE [OFF]"
    speedBtn.BackgroundColor3 = speedActive and Color3.fromRGB(20, 60, 40) or Color3.fromRGB(30, 35, 60)
...
-- 8. SUPER JUMP
local jumpBtn, jumpStroke = createButton(scrollFrame, "SUPER JUMP", 0.75, Color3.fromRGB(200, 255, 100), "⚡")

jumpBtn.MouseButton1Click:Connect(function()
    jumpActive = not jumpActive
    jumpBtn.Text = jumpActive and "⚡ SUPER JUMP [ON]" or "⚡ SUPER JUMP [OFF]"
    jumpBtn.BackgroundColor3 = jumpActive and Color3.fromRGB(20, 60, 40) or Color3.fromRGB(30, 35, 60)
...
-- 9. FLY (VOAR)
local flyBtn, flyStroke = createButton(scrollFrame, "FLY (VOAR)", 0.83, Color3.fromRGB(100, 255, 200), "🌊")

flyBtn.MouseButton1Click:Connect(function()
    flyActive = not flyActive
    flyBtn.Text = flyActive and "🌊 FLY (VOAR) [ON]" or "🌊 FLY (VOAR) [OFF]"
    flyBtn.BackgroundColor3 = flyActive and Color3.fromRGB(20, 60, 40) or Color3.fromRGB(30, 35, 60)
...
-- 10. NO CLIP
local noClipBtn, noClipStroke = createButton(scrollFrame, "NO CLIP", 0.91, Color3.fromRGB(255, 200, 100), "🧱")

noClipBtn.MouseButton1Click:Connect(function()
    noClipActive = not noClipActive
    noClipBtn.Text = noClipActive and "🧱 NO CLIP [ON]" or "🧱 NO CLIP [OFF]"
    noClipBtn.BackgroundColor3 = noClipActive and Color3.fromRGB(20, 60, 40) or Color3.fromRGB(30, 35, 60)
...
cat4.Size = UDim2.new(0.92, 0, 0, 25)
cat4.Position = UDim2.new(0.04, 0, 0.99, 0)
...
-- 11. GOD MODE
local godBtn, godStroke = createButton(scrollFrame, "GOD MODE", 1.05, Color3.fromRGB(255, 200, 100), "🛡️")

godBtn.MouseButton1Click:Connect(function()
    godModeActive = not godModeActive
    godBtn.Text = godModeActive and "🛡️ GOD MODE [ON]" or "🛡️ GOD MODE [OFF]"
    godBtn.BackgroundColor3 = godModeActive and Color3.fromRGB(20, 60, 40) or Color3.fromRGB(30, 35, 60)
...
-- 12. ANTI-KICK
local antiKickBtn, antiKickStroke = createButton(scrollFrame, "ANTI-KICK", 1.13, Color3.fromRGB(255, 150, 100), "🛡️")
...
antiKickBtn.MouseButton1Click:Connect(function()
    ...
    antiKickBtn.BackgroundColor3 = antiKickActive and Color3.fromRGB(20, 60, 40) or Color3.fromRGB(30, 35, 60)
...
-- 13. FREEZE PLAYERS
local freezeBtn, freezeStroke = createButton(scrollFrame, "FREEZE PLAYERS", 1.21, Color3.fromRGB(100, 200, 255), "🌀")

freezeBtn.MouseButton1Click:Connect(function()
    freezeActive = not freezeActive
    freezeBtn.Text = freezeActive and "🌀 FREEZE PLAYERS [ON]" or "🌀 FREEZE PLAYERS [OFF]"
    freezeBtn.BackgroundColor3 = freezeActive and Color3.fromRGB(20, 60, 40) or Color3.fromRGB(30, 35, 60)
...
-- 14. EXPLODE PLAYERS
local explodeBtn, explodeStroke = createButton(scrollFrame, "EXPLODE PLAYERS", 1.29, Color3.fromRGB(255, 100, 50), "💣")
...
-- 15. TELEPORT TO PLAYER
local teleportBtn, teleportStroke = createButton(scrollFrame, "TELEPORT TO PLAYER", 1.37, Color3.fromRGB(150, 150, 255), "📌")
...
teleportBtn.MouseButton1Click:Connect(function()
    ...
    selectFrame.Size = UDim2.new(0, 260, 0, 320)
    selectFrame.Position = UDim2.new(0.5, -130, 0.5, -160)
    selectFrame.BackgroundColor3 = Color3.fromRGB(15, 15, 35)
    selectFrame.BackgroundTransparency = 0.1
    selectFrame.BorderSizePixel = 2
    selectFrame.BorderColor3 = Color3.fromRGB(100, 150, 255)
    ...
    selectTitle.BackgroundColor3 = Color3.fromRGB(35, 40, 70)
    selectTitle.Text = "👆 Selecione o Jogador"
    selectTitle.TextColor3 = Color3.fromRGB(255, 220, 80)
    ...
    selectList.CanvasSize = UDim2.new(0, 0, 0, #players * 50)
    ...
    closeSelect.Size = UDim2.new(0, 32, 0, 32)
    closeSelect.Position = UDim2.new(1, -38, 0, 6)
...
sliderFrame.Position = UDim2.new(0.04, 0, 1.46, 0)
...
statusBar.Size = UDim2.new(0.3, 0, 0, 28)
